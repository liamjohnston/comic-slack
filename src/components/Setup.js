        ...
        return (
            <Fragment>
                <section>
                    ...
                    <div>
                        <p className="m_t_0">
                            Basically, we'll add a bunch of Comic Sans
                            characters as images to your custom emoji list in
                            Slack. Then you can use the{' '}
                            <Link
                                to="compose"
                                href="#"
                                smooth={true}
                            ...
                            to convert your boring text into glorious Comic
                            Sans.
                        </p>
                        <p>
                            Follow the setup guide below and you'll be
                            impressing your colleagues in no time.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        <p className="m_t_0">
                            Go to the 'Customize Slack' screen:
                        </p>
                        <img
                            src={imgMenu}
                        ...
                        />
                        <p>
                            The Chrome extension you just added should have
                            enable a bulk upload area on this screen. Simply
                            drag and drop the contents of the 'characters'
                            folder.
                        </p>
                ...
                <section>
                    ...
                    <div>
                        <ul className="m_t_0">
                            <li>
                                Comic Slack uses images, not a font. So you can
                                forget about kerning.
                            </li>
                            <li>
                                I've had to remove transparency from each image
                                so that they are still readable with Slack's
                                dark mode.
                            </li>
                            <li>
                                Comic Slack currently only supports a-z, 0-9 and
                                a small selection of the most common symbols.
                                Any other characters you type will render in
                                whatever garbage font Slack usually uses ;)
                            </li>
                        </ul>
                    </div>
                </section>
